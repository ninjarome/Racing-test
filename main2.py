    ...
    while not gameExit:
        ...
        for i in range(len(thing_listy)):
            ...
            if thing_listy[i] > display_height:
                ...
                thing_listx[i] = random.randrange(0, display_width)
                dodged += 1
                
            if y < thing_listy[i] + thing_height and y + car_height > thing_listy[i]:
                if x > thing_listx[i] and x < thing_listx[i] + thing_width or x + car_width > thing_listx[i] and x + car_width < thing_listx[i] + thing_width:
                    crash()
